...
![Dashboard screenshot — simulator mode showing two people tracked across the ground floor with breathing rate displays](<!-- TODO: screenshot of dashboard in demo mode -->)
